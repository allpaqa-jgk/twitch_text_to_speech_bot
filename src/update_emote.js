...
const saveImagesJson = (response) => new Promise((resolve, reject) => {
...
const saveEmoteCodeCsv = () => new Promise((resolve, reject) => {
  const jsonObject = JSON.parse(fs.readFileSync('./data/images.json', 'utf8'));
  let array = [];
