...
export const config: BotConfig = {
  ...
  COEIROINK_OUTPUT_SAMPLING_RATE: rawConfig.COEIROINK_OUTPUT_SAMPLING_RATE ?? 44100,
  COEIROINK_PAUSE_LENGTH: rawConfig.COEIROINK_PAUSE_LENGTH ?? 0.04,
  ...
  VOICEVOX_SPEED_SCALE: rawConfig.VOICEVOX_SPEED_SCALE ?? 1.0,
  VOICEVOX_VOLUME_SCALE: rawConfig.VOICEVOX_VOLUME_SCALE ?? 1.0,
  VOICEVOX_OUTPUT_SAMPLING_RATE: rawConfig.VOICEVOX_OUTPUT_SAMPLING_RATE ?? 24000,
  ...
  MASTER_VOLUME: rawConfig.MASTER_VOLUME ?? 1.0,
